...
// Override at build time: -ldflags "-X main.AppVersion=1.1.0"
//
// Deployed Pi units before this updater work are treated as v1.0.0
// (see BaselineInstalledVersion). This codebase ships as v1.1.0.
