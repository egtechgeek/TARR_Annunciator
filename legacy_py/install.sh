...
git clone https://github.com/egtechgeek/TARR_annunciator/ /opt/TARR_Annunciator
...
cd /opt/TARR_Annunciator
/opt/TARR_Annunciator/bin/gunicorn -w 4 --bind 0.0.0.0:8000 --timeout 420 app:app &
...
ExecStart=/opt/TARR_Annunciator/bin/gunicorn -w 4 --bind 0.0.0.0:8080 --timeout 420 app:app
